...
const folin::MenuItem *MenuFunctions::show_element_menu(const folin::MenuItem *current) {
    std::cout << current->title << ": " << std::endl;

    return show_global_menu(current);
};

const folin::MenuItem *MenuFunctions::show_element_with_link_menu(const folin::MenuItem *current) {
    std::cout << current->title << ": " << std::endl;
